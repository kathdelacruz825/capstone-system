  ...
  <div class="table-grades">
    <el-table :data="tableData" style="width: 100%" max-height="370">
      ...
      <el-table-column label="Grading Period">
        ...
        <el-table-column prop="ThirdGrade" label="3" width="80">
        </el-table-column>
        <el-table-column prop="FourthGrade" label="4" width="80">
        </el-table-column>
      </el-table-column>
      <el-table-column prop="OverAllGrade" label="Final Grade" width="80">
      </el-table-column>
